/**
 * Real-browser validation bundle entry point.
 *
 * Bundles the catalog's adapters, auditors, and profiles for injection into a
 * driven browser page, exposing them as window.ai4a11y (enableTool /
 * disableTool / auditors / profiles) for page.evaluate() to call. This is the
 * entry browser-validate.js builds with esbuild at run time; it carries the
 * same window.ai4a11y contract the deleted cli/cli-tools.bundle.js had, so
 * any driver (Playwright here, a future CLI elsewhere) can reuse it.
 *
 * AI-powered adapters call window.ai4a11y_* callbacks the driver may inject
 * (e.g. via Playwright exposeFunction); without them, AI features report
...
import { VisualAssist } from '../adapters/visual-assist.js';
import { DarkMode } from '../adapters/dark-mode.js';
import { MotionReducer } from '../adapters/motion-reducer.js';
import { FocusMode } from '../adapters/focus-mode.js';
import { ReadAloud } from '../adapters/read-aloud.js';
import { ReaderMode } from '../adapters/reader-mode.js';
import { VoiceCommands } from '../adapters/voice-commands.js';
import { KeyboardNavigator } from '../adapters/keyboard-nav.js';
import { ColorBlindMode } from '../adapters/color-blind.js';
...
import { AutoTranscriber } from '../adapters/auto-transcriber.js';
...
// Import auditors
import { runAxeAnalysis, getElementFromNode } from '../auditors/wcag-issues.js';
import { findEmptyAltImages, findCanvasElements, findImagesWithoutAlt } from '../auditors/missing-alt.js';
import { findVideosWithoutCaptions, findAudioWithoutTranscripts } from '../auditors/missing-captions.js';
import { findEmptyLinks, findEmptyButtons, findUnlabeledInputs, findAmbiguousLinks } from '../auditors/missing-labels.js';
import { findLowContrastText } from '../auditors/poor-contrast.js';
import { auditLandmarks } from '../auditors/missing-landmarks.js';
