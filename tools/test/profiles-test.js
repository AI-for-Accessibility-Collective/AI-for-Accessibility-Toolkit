...
const RECOGNIZED = new Set([
  ...
  'pageOutline', 'persistentHover', 'readerMode', 'reduceBrightness', 'reflowColumn', 'translatePage', 'translateTo', 'unpinSticky', 'readingGuide', 'showProgress', 'soundVisualizer', 'speechRate', 'stopAutoAdvance', 'voiceCommands',
  'fixContrast',
]);
