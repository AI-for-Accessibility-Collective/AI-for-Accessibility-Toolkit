...
// classification, profile auto-apply (customProfiles.siteTypes), the popup's
// site-type picker, and the Librarian's category-scoped memories.
//
// Platform-agnostic, dependency-free ES module. Hosts expose it however they
// need (the Chrome adapter assigns globalThis.AA_TAXONOMY).
//
...
export const TAXONOMY = {
  ...
  // contain a video). Reserved for the scope chain (`context:video` etc.);
  // listed here so the vocabulary has one home.
  contexts: [
