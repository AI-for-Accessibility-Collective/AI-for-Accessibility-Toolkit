(() => {
  ...
  var fixLog = [];
  function logFix(type, element, oldValue, newValue) {
    var _a;
  ...
  async function generateImageAlt(img) {
    ...
    try {
      ...
      if (!(response == null ? void 0 : response.success)) {
        console.warn("[AI4A11y] Alt text API failed:", (response == null ? void 0 : response.error) || "unknown error");
      }
      if ((response == null ? void 0 : response.success) && response.result) {
  ...
  // src/adapters/generate-labels.js
  ...
  // src/adapters/generate-captions.js
  async function generateVideoCaptions(video) {
    ...
    try {
      const response = await sendMessage({
        type: "transcribeVideo",
        videoUrl: src
      });
      if ((response == null ? void 0 : response.success) && ((_b = response.result) == null ? void 0 : _b.text)) {
...
`;
  ...
  // src/adapters/simplify-text.js
  async function simplifyText(element) {
    var _a;
    ...
    try {
      ...
      if ((response == null ? void 0 : response.success) && response.result) {
        const simplified = response.result;
...
`;
      ...
      if (s.dyslexiaFont) {
        css += `@font-face { font-family: 'OpenDyslexic'; src: url('${chrome.runtime.getURL("lib/OpenDyslexic-Regular.woff2")}'); }
`;
...
`;
  ...
  // src/features/motion-reducer.js
  var MotionReducer = {
  ...
  // src/features/voice-commands.js
  var VoiceCommands = {
    enabled: false,
    recognition: null,
  ...
  // src/features/auto-transcriber.js
  var AutoTranscriber = {
    enabled: false,
    observer: null,
  ...
  function applyVisualSettings(settings2) {
    ...
    const colorMode = settings2.colorBlindMode || settings2.colorFilter;
